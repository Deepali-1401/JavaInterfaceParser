...
S			: E {fprintf(yyout,"Interface Successfully Declared\n"); exit(0);}          //print message if sucessfully runs
...
BODY		: BODY PUBLIC RETURNTYPE IDENTIFIER ROUND_OPEN PARAM ROUND_CLOSE SEMICOLON       //checks either contains some functions or not
			|                                                                                //empty
			;
...
PARAM		: TYPE IDENTIFIER ',' TYPE IDENTIFIER PARAM                                 //checks parameter in function either it had one or more or nothing
			| TYPE IDENTIFIER
			|        //empty
			;
%%
